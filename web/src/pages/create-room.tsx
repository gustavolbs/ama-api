    ...
    <main className="h-screen flex items-center justify-center px-4">
      <div className="max-w-[450px] flex flex-col gap-6">
        ...
        <Link to="/rooms" className="mx-auto">
          <button className="text-center bg-orange-400 text-orange-950 px-3 py-1.5 gap-1.5 flex items-center rounded-lg font-medium text-sm transition-colors hover:bg-orange-500">
            Ver todas as salas
          </button>
        </Link>
      </div>
